...
<div class="flex flex-col items-center justify-center w-full min-h-screen">
    <div
        class="relative flex flex-col items-center justify-center w-11/12 m-auto bg-center bg-cover bg-[url('/images/hero-bg.webp')] h-[92dvh] rounded-xl text-gray-50 mt-3 xl:mt-auto"
    >
